...
SC.Widget = (function (e) {
    ...
    function (e, t, n) {
        ...
        function v(e) {
            if (e.contentWindow) return e.contentWindow;
            if (e.contentDocument && "parentWindow" in e.contentDocument)
                return e.contentDocument.parentWindow;
            return null;
        }

        function _(e) {
            var t, n = [];
            for (t in e) if (e.hasOwnProperty(t)) n.push(e[t]);
            return n;
        }
        ...
        function A(e) {
            ...
            if (!t || P(e.origin) !== P(t.domain)) return !1;
            ...
            if (t) {
                ...
                if (r === s.PLAY && !t.playEventFired) {
                    t.playEventFired = !0;
                }

                if (r === s.PLAY_PROGRESS && !t.playEventFired) {
                    t.playEventFired = !0;
                    w(t, s.PLAY, [o]);
                }
        ...
        e.exports = i = function (e, t, n) {
            ...
            if (c && c.instance) return c.instance;
        ...
        (r = function () { }).prototype = {
                ...
                if (e) {
                    ...
                    o.onload = function () {
                        n.bind(s.READY, function () {
                            var e, n = r.callbacks;
                            for (e in n)
                                if (n.hasOwnProperty(e) && e !== s.READY)
            ...
            bind: function (e, t) {
                ...
                if (r && r.element) {
                    if (e === s.READY && r.isReady) {
                        setTimeout(t, 1);
                    } else if (r.isReady) {
                        S(e, t, r);
                        y(l.ADD_LISTENER, e, r.element);
                    } else {
                        S("__LATE_BINDING__", function () {
                            n.bind(e, t);
                        }, r);
                    }
                }
            ...
            unbind: function (e) {
                ...
                if (n && n.element) {
                    t = h(e, n);
                    if (e !== s.READY && t) {
                        y(l.REMOVE_LISTENER, e, n.element);
                    }
                }
            }
        };
...
cards.forEach(element => {
    element.children[0].addEventListener("click", function(){
        widget.load(`https://soundcloud.com/soloquartet/${element.dataset.musictitle}`,
            {
                show_user: false,
...
widget.load('https://soundcloud.com/soloquartet/waltz-of-unaveling',{show_user: false, show_playcount: false});
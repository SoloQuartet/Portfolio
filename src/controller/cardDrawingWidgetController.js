...
async function enhanceImage(imageName) {
    ...
    b.children[0].src = '/Portfolio/assets/images/'+ imageName.split('Card.png')[0] +'HD.png';
    fetch("/Portfolio/assets/HtmlData/"+localStorage.language.substring(0, 2)+"/drawingData/"+imageName.split('Card.png')[0]+"Data")
